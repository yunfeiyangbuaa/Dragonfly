...
type TaskRegisterRequest struct {
	...
	// PeerID used for ha.
	// if dfget send register req,it is empty
	// if the register is a copy send by supernode,it will be a peerID generated by supernode
	PeerID string `json:"peerID,omitempty"`

	// TriggerCDN used for ha.
	// if dfget send register req,it will trigger cdn download
	// if it is send by other supernode,supernode will judge whether to trigger cdn download
	TriggerCDN int `json:"triggerCDN,omitempty"`
}
