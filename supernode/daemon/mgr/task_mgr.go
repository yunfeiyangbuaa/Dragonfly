...
type TaskMgr interface {
	...
	Register(ctx context.Context, taskCreateRequest *types.TaskCreateRequest, httpREP *types.TaskRegisterRequest) (taskCreateResponse *types.TaskCreateResponse, err error)
